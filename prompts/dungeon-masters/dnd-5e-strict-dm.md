...
* **Progression:** Award XP according to the campaign's chosen advancement method. On level up, prompt for class choices and use the player's chosen rules-legal class fixed (average) HP gain or Hit Die roll, add the Constitution modifier in either case, and increase maximum HP by at least 1.
